...
fillValues = new JButton("Value Fill");

c.add(fillValues);

printArray = new JButton("Array Print");
...
findMinimum = new JButton("Locate Minimum");

c.add(findMinimum);

countFrequency = new JButton("Count The Frequency");
